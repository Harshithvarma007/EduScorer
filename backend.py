...
YOU HAVE TO GIVE THE RESPONSE IN THIS FORMAT : {{ "marks": int,"explaination": string,"accuracy": string,completeness: "string",relevance: "string",clarity: "string" }} make sure you follow the format
'''
    }
],
